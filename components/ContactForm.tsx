...
export default function ContactForm() {
    ...
    const handleSubmit = (e: React.FormEvent<HTMLFormElement>) => {
        ...
        const termsAccepted = formData.get("terms_accepted") ? "Sí" : "No";

        // Map size value to display text
        let sizeText = "";
        switch (size) {
            case "1": sizeText = t.contact.fields.sizeOptions.s1; break;
            case "2": sizeText = t.contact.fields.sizeOptions.s2; break;
            case "3": sizeText = t.contact.fields.sizeOptions.s3; break;
            case "4": sizeText = t.contact.fields.sizeOptions.s4; break;
            default: sizeText = size.toString(); break;
        }

        const subject = encodeURIComponent("Solicitud de contacto Scalia - " + company);
        const body = encodeURIComponent(
            ...
            "Teléfono: " + phone + "\\n" +
            "Sitio Web: " + website + "\\n" +
            "Tamaño de la empresa: " + sizeText + "\\n\\n" +
            "¿Qué desea optimizar?:\\n" + optimization + "\\n\\n" +
            "Mensaje adicional:\\n" + additional + "\\n\\n" +
            "Términos y condiciones aceptados: " + termsAccepted
        );
    ...
    return (
        <div className="w-full mx-auto relative cursor-default">
            <form
